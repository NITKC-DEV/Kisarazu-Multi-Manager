...
export default [
    ...
    },
    {
        data: new SlashCommandBuilder()
            ...
            .addIntegerOption((option: any) => option.setName("年").setDescription("テストが実施される年を入力").setRequired(true))
            .addIntegerOption((option: any) => option.setName("開始月").setDescription("テストが開始される月を入力").setRequired(true))
            .addIntegerOption((option: any) => option.setName("開始日").setDescription("テストが開始される日を入力").setRequired(true))
            .addIntegerOption((option: any) => option.setName("終了月").setDescription("テストが終了する月を入力").setRequired(true))
            .addIntegerOption((option: any) => option.setName("終了日").setDescription("テストが終了する日を入力").setRequired(true))
            .addIntegerOption((option: any) => option.setName("テスト回").setDescription("何回後のテストか入力(1~4)").setRequired(true)),
