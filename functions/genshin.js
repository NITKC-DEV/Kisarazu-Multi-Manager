...
exports.func = function func(genshindaily) {
    const daily = {
        color: 0x27668D,
        title: 'デイリー更新',
        author: {
    ...
    genshindaily.send({ embeds: [daily] })
    let dt = new Date();
    ...
    if (dayofweek === 1) { /*月曜日*/
        ...
        genshindaily.send({ embeds: [monday] })
    }
    ...
    if (dayofweek === 4) { /*木曜日*/
        ...
        genshindaily.send({ embeds: [thursday] })
    }
    ...
    if (dayofweek === 5) { /*金曜日*/
        ...
        genshindaily.send({ embeds: [friday] })
    }
    ...
    if (dayofweek === 6) { /*土曜日*/
        ...
        genshindaily.send({ embeds: [saturday] })
    }
    if (date % 3 === 0) { /*3の倍数の日*/
        const multiple = {
            color: genshinColor,
        ...
        genshindaily.send({ embeds: [multiple] })
    }
    if (date % 3 === 1) { /*3の倍数+1の日*/
        ...
        genshindaily.send({ embeds: [multiple2] })
    }
    ...
    if (date === 1) { /*毎月1日*/
        ...
        genshindaily.send({ embeds: [first] })
    }
    if (date === 16) { /*毎月16日*/
        const sixteenth = {
            color: genshinColor,
        ...
        genshindaily.send({ embeds: [sixteenth] })
    }
